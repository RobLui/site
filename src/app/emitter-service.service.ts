...
export class EmitterServiceService {
     ...
     getPokemon() : Observable<Pokemon[]>{
         ...
         return this.http.get(this.url)
                        // ...and calling .json() on the response to return data
                         ...
                         //...errors if any
                         .catch((error:any) => Observable.throw(error.json().error || 'Error - Port 3000 not running'));
                         }
    ...
    addPokemon (body: Object): Observable<Pokemon[]> {
        ...
        return this.http.post(this.url, body, options) // ...using post request
                         ...
                         .catch((error:any) => Observable.throw(error.json().error || 'Error - Adding failed, data is insered tho..')); //...errors if any
    }
