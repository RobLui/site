...
var EmitterServiceService = (function () {
    ...
    EmitterServiceService.prototype.getPokemon = function () {
        ...
        return this.http.get(this.url)
            ...
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Observable"].throw(error.json().error || 'Error - Port 3000 not running'); });
    };
    // Add a new pokemon
    EmitterServiceService.prototype.addPokemon = function (body) {
        ...
        return this.http.post(this.url, body, options) // ...using post request
            ...
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Observable"].throw(error.json().error || 'Error - Adding failed, data is insered tho..'); }); //...errors if any
    };
    // Update pokemon
...
/***/ "../../../../../src/app/pokemon-box/pokemon-box.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
var PokemonBoxComponent = (function () {
    ...
    PokemonBoxComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* Component */])({
            ...
            styles: [__webpack_require__("../../../../../src/app/pokemon-box/pokemon-box.component.css")]
        }), 
...
/***/ "../../../../../src/app/pokemon-form/pokemon-form.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
var PokemonFormComponent = (function () {
    ...
    PokemonFormComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* Component */])({
            ...
            styles: [__webpack_require__("../../../../../src/app/pokemon-form/pokemon-form.component.css")]
        }), 
...
module.exports = "<app-pokemon-box [editId]=\"editId\" [listId]=\"listId\" *ngFor=\"let pokemon of pokemon\" [pokemon]=\"pokemon\">\n</app-pokemon-box>\n"
...
var PokemonListComponent = (function () {
    ...
    PokemonListComponent.prototype.ngOnChanges = function (changes) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__emitter_service_service__["a" /* EmitterServiceService */].get(this.listId).subscribe(function (pokemon) { _this.pokemon = pokemon; });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* Input */])(), 
        __metadata('design:type', String)
